...
/*!
 @category NSObject(MOPWRuntimeUtilities)
 @abstract NSObject runtime extension methods.
 @discussion NSObject runtime extension methods.
 */
@interface NSObject (MOPWRuntimeUtilities)

/*!
 @method MOPW_allSubclassesIncludingIndirect:
 ...
 */
+ (NSArray *)MOPW_allSubclassesIncludingIndirect:(BOOL)deepFlag;

/*!
 @method MOPW_replaceInstanceSelector:withMethodForSelector:
...
&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;&#32;[NSView MOPW_replaceInstanceSelector:&#64selector(setFrameSize:)
 ...
 */
+ (IMP)MOPW_replaceInstanceSelector:(SEL)replaceSel withMethodForSelector:(SEL)newSel;

/*!
 @method MOPW_replaceFactorySelector:withMethodForSelector:
 ...
 @result The original IMP for replaceSel.
 */
+ (IMP)MOPW_replaceFactorySelector:(SEL)replaceSel withMethodForSelector:(SEL)newSel;

@end

/*!
 @category NSBundle(MOPWRuntimeUtilities)
 @abstract NSBundle runtime extension methods.
 @discussion NSBundle runtime extension methods.
 */
@interface NSBundle (MOPWRuntimeUtilities)

/*!
 @method MOPW_allClasses
 ...
 */
- (NSArray *)MOPW_allClasses;

@end

/*!
 @category Protocol(MOPWRuntimeUtilities)
 @abstract Protocol runtime extension methods.
 @discussion Protocol runtime extension methods.
 */
@interface Protocol (MOPWRuntimeUtilities)

/*!
 @method MOPW_allConformingClasses
 ...
 @result The array of classes.
 */
- (NSArray *)MOPW_allConformingClasses;

@end

/*!
 @function MOPWFullMethodName
 ...
 */
MOKIT_EXTERN NSString *MOPWFullMethodName(id self, SEL _cmd);

/*!
 @function MOPWAllClasses
 ...
 @result The array of classes.
 */
MOKIT_EXTERN NSArray *MOPWAllClasses();

/*!
 @function MOPWAllClassesImplementingInstanceSelector
 ...
 @result The array of classes.
 */
MOKIT_EXTERN NSArray *MOPRAllClassesImplementingInstanceSelector(SEL selector);

/*!
 @function MOPWAllClassesImplementingFactorySelector
 ...
 @result The array of classes.
 */
MOKIT_EXTERN NSArray *MOPWAllClassesImplementingFactorySelector(SEL selector);

/*!
 @function MOPWKitAllowsMethodReplacement
 @abstract Returns whether MOKit itself should enable features depending of method replacement.
 @discussion Returns whether MOKit itself should enable features depending of method replacement.  Note that this has no affect on the function of the method replacement API itself.  Clients of MOKit may replace methods as they see fit, but any features of MOKit itself that use method replacement check this function.  The function in turn looks at the value of the MOPWKitAllowsMethodReplacement user default which is YES by default.  If it is set to NO, then MOKit will disable all method replacement features.
 @result YES if method replacement should be allowed, NO if not.
 */
MOKIT_EXTERN BOOL MOPWKitAllowsMethodReplacement();

/*!
 @function MOPWKitSetAllowsMethodReplacement
 @abstract Sets whether MOKit itself should enable features depending of method replacement.
 @discussion Sets whether MOKit itself should enable features depending of method replacement.  Note that this has no affect on the function of the method replacement API itself.  Clients of MOKit may replace methods as they see fit, but any features of MOKit itself that use method replacement will obey this setting.  The function sets the value of the MOPWKitAllowsMethodReplacement user default which is YES by default.  If it is set to NO, then MOKit will disable all method replacement features.
 ...
 */
MOKIT_EXTERN void MOPWKitSetAllowsMethodReplacement(BOOL flag);
